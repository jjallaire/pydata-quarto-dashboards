...
::: {.column width="50%"}
![](images/posit-b-corp.png){style="margin-left: 1em" width="80%"}
![](images/posit-b-impact.png){style="margin-left: 1em" width="80%"}
:::
:::
...
::: incremental
-  _Code First Data Science_ means doing flexible, iterative, re-usable, inspectable, and reproducible data science with code.
...
-   Our hope is to make the most open, flexible, and powerful way of doing data science as straightforward and seamless as possible. 
:::
...
-   Work collaboratively with the Python community to realize the potential of code first data science.
    ...
    - What needs to be better integrated? 
